          ...
          <nav className="hidden lg:flex items-center gap-8">
            {navLinks.map((link) => (
              <a
                ...
                className={`relative font-medium transition-colors duration-200 cursor-pointer after:absolute after:left-0 after:-bottom-1 after:h-[2px] after:bg-gold after:transition-all after:duration-300 ${
                  isRouteActive(link.route)
                    ? "text-gold-dark after:w-full"
                    : "text-foreground/80 hover:text-gold-dark after:w-0 hover:after:w-full"
                }`}
              >
                {link.label}
              </a>
              ...
              {navLinks.map((link) => (
                <a
                  ...
                  className={`px-6 py-3 font-medium transition-all cursor-pointer ${
                    isRouteActive(link.route)
                      ? "text-gold-dark bg-muted/60"
                      : "text-foreground/80 hover:text-gold-dark hover:bg-muted/50"
                  }`}
                  onClick={(e) => handleNavClick(link, e)}
                >
                  {link.label}
